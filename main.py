...
░░░╚═╝░░░╚═╝░░╚═╝░╚════╝░░╚═════╝░░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝╚═╝░░╚═╝░╚═════╝░╚═════╝░
    ...
    print_border("ATF MINER - AITRADINGFOREX", Fore.GREEN)
...
async def run_social(language):
    from scripts.social import run_social
    await run_social(language)

async def run_claimref(language):
    from scripts.claimref import run_claimref
    await run_claimref(language)
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Tự động đào $ATF", "value": "mining"},
            {"name": "2. Tự động làm nhiệm vụ", "value": "social"},
            {"name": "3. Tự động Claim Referral", "value": "claimref"},
          
            {"name": "X. Thoát", "value": "exit"},
        ],
        'en': [
            {"name": "1. Automatic mining $ATF", "value": "mining"},
            {"name": "2. Automatic complete tasks", "value": "social"},
            {"name": "3. Automatic Claim Referral", "value": "claimref"},
